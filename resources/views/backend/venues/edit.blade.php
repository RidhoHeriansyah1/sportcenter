                    ...
                    <div class="card-body">
                                ...
                                <form action="{{ route('backend.venues.update', $data->id) }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="number" name="category_id" value="{{ $data->category_id }}" class="form-control">
                                    </div>
                                    <div class="mb-3">
                                        <label for="location" class="form-label">Patner ID</label>
                                        <input type="number" name="patner_id" value="{{ $data->patner_id }}" class="form-control">
                                    </div>
                                    <div class="mb-3">
                                        <label for="location" class="form-label">Location ID</label>
                                        <input type="number" name="location_id" value="{{ $data->location_id }}" class="form-control">
                                    </div>
                                    <div class="mb-3">
