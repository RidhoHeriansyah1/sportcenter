...
{{-- Judul Page --}}
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
            ...
            <a href="{{ route('backend.venues.create') }}" class="btn btn-sm btn-success add-btn">
                <i class="ri-add-line align-bottom me-1"></i> Create</a>
        </div>
        {{-- End Judul Card --}}
        <div class="card-body">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex gap-2">
                                                ...
                                                <div class="edit">
                                                    <a href="{{ route('backend.venues.edit', $item->id) }}" class="btn btn-sm btn-success edit-item-btn"><i
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="d-flex gap-2 justify-content-center mt-4 mb-2">
                            ...
                            <form action="{{ route('backend.venues.destroy', $item->id)}}" method="POST">
                                @csrf
                                @method('DELETE')
                                <button type="button" class="btn w-sm btn-light" data-bs-dismiss="modal">Close</button>
